...
my $verif_cmd = "make cleanall run RUN=\"+testname=$testvector\" >& out.log";
...
print "\n\nRunning Synthesis \@clk_period=0.8ns\n" ;
my $syn_cmd = "make cleanall run_dc CLK_PERIOD=0.8 >& out.log";
...
$synthStatus==0 and print "Failed synth \@clk_period=0.8ns\n" ;
$synthStatus==1 and print "Passed synth \@clk_period=0.8ns\n" ;
