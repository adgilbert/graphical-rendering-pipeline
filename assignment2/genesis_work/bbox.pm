...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/bbox.vp');
# START USER CODE FROM /afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/bbox.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/bbox.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //R10 Signals';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [2:0] x_comp_R10S;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   logic [2:0] y_comp_R10S;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   //Calculate bounding box using gold code as model';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   x_comp_R10S[0] =  poly_R10S[0][0] < poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   x_comp_R10S[1] =  poly_R10S[0][0] < poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   x_comp_R10S[2] =  poly_R10S[1][0] < poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   y_comp_R10S[0] =  poly_R10S[0][1] < poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   y_comp_R10S[1] =  poly_R10S[0][1] < poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   y_comp_R10S[2] =  poly_R10S[1][1] < poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   // poly_R10S[vert][axis]';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   case (x_comp_R10S)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b11x:  box_R10S[0][0] = poly_R10S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b0x1:  box_R10S[0][0] = poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'bx00:  box_R10S[0][0] = poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      default: box_R10S[0][0] = poly_R10S[0][0]; // should never occur';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   case (x_comp_R10S)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b00x:  box_R10S[1][0] = poly_R10S[0][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b1x0:  box_R10S[1][0] = poly_R10S[1][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'bx11:  box_R10S[1][0] = poly_R10S[2][0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      default: box_R10S[1][0] = poly_R10S[0][0]; // should never happen';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   case (y_comp_R10S)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b11x:  box_R10S[0][1] = poly_R10S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b0x1:  box_R10S[0][1] = poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'bx00:  box_R10S[0][1] = poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      default: box_R10S[0][1] = poly_R10S[0][1]; // should never occur';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   case (y_comp_R10S)';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b00x:  box_R10S[0][1] = poly_R10S[0][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'b1x0:  box_R10S[0][1] = poly_R10S[1][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      3\'bx11:  box_R10S[0][1] = poly_R10S[2][1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      default: box_R10S[0][1] = poly_R10S[0][1]; // should never occur';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   endcase';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      rounded_box_R10S['; print { $self->{OutfileHandle} } $i; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $j; print { $self->{OutfileHandle} } ']['; print { $self->{OutfileHandle} } $radix; print { $self->{OutfileHandle} } '-1:0] = 0; ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      ';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '   // box_R10S[1][1]: UR Y';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      if (rounded_box_R10S[0][0] < 0) out_box_R10S = 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      if (rounded_box_R10S[0][1] < 0) out_box_R10S = 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      if (rounded_box_R10S[1][0] > screen_RnnnnS[0]) out_box_R10S = screen_RnnnnS[0];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      if (rounded_box_R10S[1][1] > screen_RnnnnS[1]) out_box_R10S = screen_RnnnnS[1];';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      if (rounded_box_R10S[0][0] < screen_RnnnnS[0] &&';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '          rounded_box_R10S[1][0] > 0 &&';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '          rounded_box_R10S[0][1] < screen_RnnnnS[1] &&';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '          rounded_box_R10S[1][1] > 0) ';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '         outvalid_R10H = 1;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '      else outvalid_R10H = 0;';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '   end';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/bbox.vp PARSED INTO PACKAGE
