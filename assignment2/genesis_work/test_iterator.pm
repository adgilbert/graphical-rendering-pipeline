...
############################### Module Starts Here ###########################
  ...
  sub to_verilog{ 
	...
	$self->SUPER::to_verilog('/afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/test_iterator.vp');
# START USER CODE FROM /afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE >>>
# line 1 "/afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/test_iterator.vp"
...
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
print { $self->{OutfileHandle} } '';print { $self->{OutfileHandle} } "\n"; 
# <<< END USER CODE FROM /afs/.ir.stanford.edu/users/a/d/adgil/EE271/EE271_project/assignment2/rtl/test_iterator.vp PARSED INTO PACKAGE
